<li class="">
    ...
    <!-- Dropdown menu -->
    <div style="top: 63px" id="full-width-megamenu" aria-labelledby="full-width-megamenu" class="dropdown-menu animate-fade z-10  lg:absolute top-full left-0 right-0 m-auto bg-white rounded-lg shadow-[0px_15px_30px_0px_rgba(16,24,40,0.1)] lg:px-12 xl:px-12 md:px-12 p-12 max-w-screen-2xl xl:py-12 lg:12-4 md:py-2l hidden ">
        <div>
            <div class="relative tab-group">
                <div class="flex bg-stone-100 p-0.5 relative rounded-lg" role="tablist" style="    background: #000;margin: 7px;">
                    ...
                    <a  href="#" class="tab-link flex items-center text-sm active inline-block py-2 px-4 text-stone-800 transition-all duration-300 relative z-1 mr-1 hover:bg-primary-200 active:bg-primary-200" data-dui-tab-target="tabm1-group2">
