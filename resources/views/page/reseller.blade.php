<x-layouts.app>
    <x-section.columns class="max-w-full w-full mt-6  px-20" style="background: #000">
        ...
        <x-section.column class="w-2/3 pt-20 pb-20" style="padding-top: 7rem; padding-bottom: 7rem">
            ...
            <p class="mt-4 font-extralight" style="color: white">
                {{ __('Become a Wurk Premium Reseller, Whitelabel - Grow as we grow') }}
            </p>

            <p class="mt-4" style="color: white">
                Wurk’s Reseller Program allows you to create your own pricing, manage and promote your own brand, Wurk managed security of your clientele,
                Manage your customers, and invoice your own customers.
            ...
            <div class="mt-[36px] flex items-center justify-between gap-4 sm:justify-start 2xl:gap-10">
                <a href="https://store.wurkapps.com/register.php" class="text-black linear rounded-md bg-white px-4 py-2 text-center text-base font-medium transition duration-200 hover:!bg-white/80 active:!bg-white/70">
                   Become a Wurk Premium Reseller
                </a>
            </div>
        </x-section.column>

        <x-section.column class="w-1/3 pt-20 pb-20 hidden lg:block" style="background-size:cover !important; padding-top: 7rem; padding-bottom: 7rem; background: url({{URL::asset('/images/reseller.jpg')}})">
            <div x-intersect="$el.classList.add('slide-in-top')">
...
{{--                    <small class="font-extralight">Amanda Santos</small> <br /> <small>Sales Manager</small>--}}
    ...
    <div class="text-center pt-4 p-4 pb-0 md:pt-16 md:mb-10">
        <x-heading.h1 class="font-extralight">
            Resell Everything on Wurk
        </x-heading.h1>
        <small class="font-extralight">
            Create your own Tech business and set your prices and terms. Designed to drive your business growth and enhance your clients’ online experiences, <br /> Wurk’s reseller programme leads the way in performance, dependable support, and affordability.
...
{{--                    <a class="text-black hover:text-gray-500" href="/page/category/support?product_category={{$category->portal}}">--}}
                    <a style="margin: 10px; background: #000" class="text-white hover:text-gray-500 hover:bg-[#1f2937]/90" href="https://store.wurkapps.com/store/wurk-apps">
